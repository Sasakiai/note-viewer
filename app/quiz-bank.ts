...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    prompt: "Co przechowuje słownik według notatki?",
    type: "shortText",
    acceptedAnswers: [
      "pary klucz wartość",
      "klucz wartość",
  ...
  },
  {
    ...
    noteSlug: "slownik-hashmap-bst-i-avl",
    prompt: "Które operacje są podstawowe dla słownika według notatki?",
    type: "multiChoice",
    options: [
  ...
  },
  {
    ...
    noteSlug: "slownik-hashmap-bst-i-avl",
    prompt: "Jak działa HashMap według notatki?",
    type: "singleChoice",
    options: [
  ...
  },
  {
    ...
    noteSlug: "slownik-hashmap-bst-i-avl",
    prompt: "Do jakich operacji HashMap według notatki nie nadaje się dobrze?",
    type: "multiChoice",
    options: [
      { id: "a", label: "Minimum" },
      { id: "b", label: "Maksimum" },
  ...
  },
  {
    ...
    noteSlug: "slownik-hashmap-bst-i-avl",
    prompt: "Czym zastępujemy w BST usuwany węzeł mający dwoje dzieci według notatki?",
    type: "shortText",
    acceptedAnswers: [
      "następnikiem",
  ...
  },
  {
    id: "avl-lr-naprawa",
    noteSlug: "slownik-hashmap-bst-i-avl",
    prompt: "Jak naprawiamy przypadek `LR` w AVL według notatki?",
    type: "singleChoice",
    options: [
  ...
  },
  {
    ...
    prompt: "Które operacje na liście jednokierunkowej mają według notatki koszt `O(1)`?",
    type: "multiChoice",
    options: [
  ...
  },
  {
    ...
    noteSlug: "najwazniejsze-operacje-i-zlozonosci",
    prompt: "Jakie operacje na liście dwukierunkowej wymagają według notatki wskaźnika `tail`, żeby działać w `O(1)`?",
    type: "multiChoice",
    options: [
      { id: "a", label: "`pushBack`" },
      { id: "b", label: "`popBack`" },
  ...
  },
  {
    ...
    noteSlug: "najwazniejsze-operacje-i-zlozonosci",
    prompt: "Które porównanie budowy kopca jest zgodne z notatką?",
    type: "singleChoice",
    options: [
  ...
  },
  {
    ...
    noteSlug: "najwazniejsze-operacje-i-zlozonosci",
    prompt: "Od czego zależy złożoność `search`, `insert` i `delete` w BST według notatki?",
    type: "shortText",
    acceptedAnswers: [
  ...
  },
  {
    ...
    noteSlug: "najwazniejsze-operacje-i-zlozonosci",
    prompt: "Jaką złożoność ma wyszukiwanie skokami co `k` według notatki?",
    type: "shortText",
    acceptedAnswers: ["θ(n/k + k)", "Θ(n/k + k)", "theta(n/k + k)"],
  ...
  },
  {
    ...
    noteSlug: "najwazniejsze-operacje-i-zlozonosci",
    prompt: "Który zestaw złożoności dla CountSort jest zgodny z notatką?",
    type: "singleChoice",
    options: [
