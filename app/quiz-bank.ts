...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    noteSlug: "kolejka-priorytetowa-i-kopiec-binarny",
    prompt: "Które operacje są podane w notatce jako podstawowe dla kolejki priorytetowej?",
    type: "multiChoice",
    options: [
    ...
    correctOptionIds: ["a", "b", "c"],
    referenceAnswer: "Notatka podaje operacje `insert(e, p)`, `findMin()` i `delMin()`.",
    explanation: "",
  },
  {
    id: "kopiec-dwie-wlasnosci",
    noteSlug: "kolejka-priorytetowa-i-kopiec-binarny",
    prompt: "Jakie dwie najważniejsze własności ma kopiec binarny według notatki?",
    type: "multiChoice",
    options: [
  ...
  },
  {
    ...
    noteSlug: "kolejka-priorytetowa-i-kopiec-binarny",
    prompt: "Które porównanie sposobów budowy kopca jest zgodne z notatką?",
    type: "singleChoice",
    options: [
